...
contract FHEZamaTalk is SepoliaConfig {
    ...
    function _getOrCreateConversation(address from, address to) internal returns (uint256) {
        ...
        if (convId != 0) {
            conversations[convId].createdAt = _now();
            return convId;
        }
    ...
    /// @dev This is a view function. It does not update message or conversation state.
    /// @param conversationId ID of the conversation
    /// @return out Array of Message structs belonging to the conversation
